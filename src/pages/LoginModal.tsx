        ...
        <div className="liquid-glass-strong relative w-full max-w-md animate-fadeIn">
          ...
          <div className="p-8">
            ...
            {resetSent ? (
              ...
              <form onSubmit={async (e) => { e.preventDefault(); await requestPasswordReset(resetEmail); setResetSent(true); }} className="mt-8 space-y-4">
                <div>
...
function DevQuickLogin({ setEmail, setPassword }: { setEmail: (e: string) => void; setPassword: (p: string) => void }) {
  ...
  return (
    <div className="space-y-2">
      <div className="mb-2 text-[10px] uppercase tracking-wider text-zinc-500 text-center">Dev Quick Login</div>
